    ...
    <div>
      ...
      <section className="max-w-5xl mx-auto px-4 py-8 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
        ...
        <div className="bg-white rounded-xl shadow-lg p-6 flex flex-col items-center border-t-4 border-[#0A2463] hover:scale-105 transition">
          ...
          <p className="text-gray-700 mb-4 text-center">Obtén tu Tarjeta Verde y asegura tu futuro en EE.UU. Te guiamos en cada paso del proceso.</p>
          <a href="/servicios/residencia-permanente" className="mt-auto bg-[#D9A404] text-white px-4 py-2 rounded hover:bg-[#b88a03] transition">Ver más</a>
        </div>
        {/* Asilo Político */}
        <div className="bg-white rounded-xl shadow-lg p-6 flex flex-col items-center border-t-4 border-[#0A2463] hover:scale-105 transition">
          ...
          <a href="/servicios/asilo-politico" className="mt-auto bg-[#D9A404] text-white px-4 py-2 rounded hover:bg-[#b88a03] transition">Ver más</a>
        </div>
        {/* Visa U */}
        <div className="bg-white rounded-xl shadow-lg p-6 flex flex-col items-center border-t-4 border-[#0A2463] hover:scale-105 transition">
          <span className="text-4xl mb-2">🛡️</span>
          ...
          <a href="/servicios/visa-u" className="mt-auto bg-[#D9A404] text-white px-4 py-2 rounded hover:bg-[#b88a03] transition">Ver más</a>
        </div>
        {/* DACA */}
        <div className="bg-white rounded-xl shadow-lg p-6 flex flex-col items-center border-t-4 border-[#0A2463] hover:scale-105 transition">
          <span className="text-4xl mb-2">🌟</span>
          ...
          <a href="/servicios/daca" className="mt-auto bg-[#D9A404] text-white px-4 py-2 rounded hover:bg-[#b88a03] transition">Ver más</a>
        </div>
        {/* Perdón Provisional */}
        <div className="bg-white rounded-xl shadow-lg p-6 flex flex-col items-center border-t-4 border-[#0A2463] hover:scale-105 transition">
          <span className="text-4xl mb-2">📄</span>
          ...
          <a href="/servicios/perdon-provisional" className="mt-auto bg-[#D9A404] text-white px-4 py-2 rounded hover:bg-[#b88a03] transition">Ver más</a>
        </div>
        {/* Otros servicios */}
        <div className="bg-white rounded-xl shadow-lg p-6 flex flex-col items-center border-t-4 border-[#0A2463] hover:scale-105 transition">
          <span className="text-4xl mb-2">⚖️</span>
          ...
          <a href="/servicios/otros" className="mt-auto bg-[#D9A404] text-white px-4 py-2 rounded hover:bg-[#b88a03] transition">Ver más</a>
        </div>
      </section>
      <Ondas />
    </div>
